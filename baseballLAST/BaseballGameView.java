package com.baseball;
	...
	public class BaseballGameView extends JFrame {
		BaseballGameEvent baseEven;
		
		//BaseballGameLogic bbgl = new BaseballGameLogic(this);
		...
		/*static BaseballGameView bbgv = null;
		public BaseballGameView getInstance() {
			bbgv = new BaseballGameView();
			return bbgv;
		}*/
	        ...
	        JButton jbtn_exit 		= new JButton("나가기");
	      	public void initDisplay() {//사용자정의메소드
			     //이벤트 소스와 이벤트 처리를 담당하는 클래스 연결
	      		 baseEven = new BaseballGameEvent(this); 	
